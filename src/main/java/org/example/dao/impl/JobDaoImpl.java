...
public class JobDaoImpl implements JobDao {
    ...
    public void createJobTable() {
        ...
        try (Connection connection = Config.getConnection();
            ...
            System.out.println("Successfully create jobs!!! ");
    ...
    public void addJob(Job job) {
        ...
        try (Connection connection = Config.getConnection();
            ...
            System.out.println("Successfully add job!!!");
        } catch (SQLException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    public List<Job> sortByExperience(String ascOrDesc) {
        ...
        switch (ascOrDesc) {
            ...
            case "desc" -> {
                ...
                try (Connection connection1 = Config.getConnection();
            ...
            default -> System.out.println("asc or desc");
        }
        return jobs;
    }
    ...
    public Job getJobByEmployeeId(Long employeeId) {
        Job job = null;
        String sql = "select * from jobs c join employees b on c.id = b.id;";
        try (Connection connection = Config.getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                job = new Job(
                        resultSet.getString(job.getPosition()),
                        resultSet.getString(job.getProfession()),
                        resultSet.getString(job.getDescription()),
                        resultSet.getInt(job.getExperience())
                );
            }
        } catch (SQLException e) {
            System.out.println(e.getMessage());
